...
enemy1.setVelocity(-9,0);
enemy2.setVelocity(9,0);
enemy3.setVelocity(9,0);
...
if(hero.isTouching(net)){
  playSound("assets/category_background/intermission_whispering.mp3");
  hero.x=200;
  hero.y=345
  goal=goal+1
}
...
textSize(20)
  ...
  playSound("assets/category_nature/summer_forest_loop.mp3", false);
